//63.	Desarrolle la función “múltiplo” que recibe dos valores enteros y emite “verdadero” si el 
//primero es múltiplo del segundo. Desarrolle la función “areaRectangulo” que reciba 3 parámetros 
